...
rem encrypt Spectral.db.gz  Spectral.db.gz!  FuckM$Defender 256 && move /y Spectral.db.gz!  Spectral.db.gz 
    encrypt Spectral.db.rar Spectral.db.rar! FuckM$Defender 256 && move /y Spectral.db.rar! Spectral.db.rar
